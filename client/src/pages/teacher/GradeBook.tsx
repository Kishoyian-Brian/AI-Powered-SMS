...
export default function TeacherGradeBook() {
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Grade Book</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Manage student grades and assessments</p>
      </motion.div>
